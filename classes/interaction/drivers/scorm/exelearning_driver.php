...
/**
 * Driver metadata for straightforward eXeLearning SCORM packages.
 */
class exelearning_driver extends base_driver {
    public function get_name(): string {
        return 'eXeLearning SCORM';
    }
    ...
    public function supports(array $context): bool {
        return ($context['authoringtool'] ?? '') === 'exelearning';
    }
}
